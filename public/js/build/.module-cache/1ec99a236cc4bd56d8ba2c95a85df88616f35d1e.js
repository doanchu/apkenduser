      ...
      React.createElement("a", {href: "/app/" + this.props.appId + ".html", className: "item-link item-content"}, 
        ...
        React.createElement("div", {className: "item-inner"}, 
          React.createElement("div", {className: "item-title-row"}, 
            ...
            React.createElement("div", {className: "item-after", onClick: this.handleDownload, className: " btn-download", href: "/app/download/" + document.partner + "/" + this.props.appId}, React.createElement("i", {class: "glyph-icon  flaticon-download164"}))
          ), 
