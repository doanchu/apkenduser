            ...
            React.createElement("div", {className: "pages navbar-through toolbar-through"}, 
              React.createElement("div", {'data-page': "index", className: "page detailt-colection"}, 
                ...
                React.createElement("div", {className: "page-content"}, 
                  ...
                  React.createElement("div", {className: "content-block-title "}, "Top Game Chơi Trung Thu"), 
                  React.createElement("div", {className: "row lst_colection"}, 
                    React.createElement("div", {className: "col-100 tablet-50 item"}, 
                      React.createElement("img", {src: "http://image.sangame.net/images/2014/06/25/6qB.jpg"})
                    )
                  ), 
                  React.createElement("div", {className: "list-block media-list lst_item"}, 
                    React.createElement("ul", null, 
                      React.createElement("li", null, 
                        React.createElement("a", {href: "#", className: "item-link item-content"}, 
                          ...
                          React.createElement("div", {className: "item-inner"}, 
                            React.createElement("div", {className: "item-title-row"}, 
                              React.createElement("div", {className: "item-title"}, "Yellow Submarine asd vfs"), 
                              React.createElement("div", {className: "item-after"}, " ", React.createElement("i", {className: "glyph-icon  flaticon-download164"}), " ")
                            ), 
                            React.createElement("div", {className: "item-subtitle"}, "lượt tải(100+)"), 
                            React.createElement("div", {className: "item-text"}, "Ứng dụng thuần việt...")
                          )
                        )
                      ), 
                      React.createElement("li", null, 
