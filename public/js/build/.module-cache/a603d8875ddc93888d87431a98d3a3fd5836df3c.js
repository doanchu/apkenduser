        ...
        React.createElement("div", {className: "views"}, 
          ...
          React.createElement("div", {className: "view view-main"}, 
            ...
            React.createElement("div", {className: "navbar"}, 
              ...
              React.createElement("div", {'data-page': "index", className: "navbar-inner"}, 
                React.createElement("div", {className: "left"}, 
                  /* Right link contains only icon - additional "icon-only" class*/React.createElement("a", {href: "#", className: "link icon-only open-panel"}, "  ", React.createElement("i", {className: "glyph-icon flaticon-list89"}))
                ), 
                /* We have home navbar without left link*/
                React.createElement("div", {className: "center"}, "Kho ứng dụng"), 
                React.createElement("div", {className: "right"}, 
                  ...
                  React.createElement("div", {className: "row lst_category"}, 
                    React.createElement("div", {className: "col-33 item"}, 
                      React.createElement("a", {href: "#"}, 
                        React.createElement("img", {src: "http://apk.vn/static/images/2014/10/25/1414205904/package_games_kids.png"}), 
                        React.createElement("span", null, " Ứng dụng việt ")
                      )
                    ), 
                    React.createElement("div", {className: "col-33 item"}, 
                      React.createElement("a", {href: "#"}, 
            ...
            React.createElement("div", {className: "toolbar tabbar tabbar-labels"}, 
              React.createElement("div", {className: "toolbar-inner"}, 
                React.createElement("a", {href: "#view-1", className: "tab-link active"}, React.createElement("i", {className: "glyph-icon flaticon-home149"}), 
                  React.createElement("span", {className: "tabbar-label"}, "Trang chủ")
                ), 
                React.createElement("a", {href: "#view-2", className: "tab-link"}, React.createElement("i", {className: "glyph-icon flaticon-favorite22"}), 
                  React.createElement("span", {className: "tabbar-label"}, "Hot")
                ), 
                React.createElement("a", {href: "#view-3", className: "tab-link"}, React.createElement("i", {className: "glyph-icon flaticon-menu55"}), 
                  React.createElement("span", {className: "tabbar-label"}, "Danh mục")
                ), 
                React.createElement("a", {href: "#view-3", className: "tab-link"}, React.createElement("i", {className: "glyph-icon flaticon-show6"}), 
                  React.createElement("span", {className: "tabbar-label"}, "Chọn lọc")
                ), 
                React.createElement("a", {href: "#view-4", className: "tab-link"}, React.createElement("i", {className: "glyph-icon flaticon-search100"}), 
                  React.createElement("span", {className: "tabbar-label"}, "Tìm kiếm")
                )
              )
            )
          )
