...
var routes = (
  <Routes location={loc} onChange={fn}>
    ...
    <Route name="AppDetailsWhenOneOldDownload" path="/app/download/:appId.apk" route="/app/download" handler={AppDetails}>        
    </Route>     

    <Route name="AppDetailsWhenDownload" path="/app/download/:partner/:appId" route="/app/download" handler={AppDetails}>        
    </Route>     

    <Route name="AppDetailsWhenOldDownload" path="/download/:appId.html" route="/app/download" handler={AppDetails}>        
    </Route>     
