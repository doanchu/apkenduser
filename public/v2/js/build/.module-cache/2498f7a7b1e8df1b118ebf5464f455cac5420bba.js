    ...
    if (this.state.data.length != 0) {
        bannerList = this.state.data.map(function(item){
          if (item != null) {
            ...
            return (
                React.createElement("div", {className: "item"}, React.createElement(Link, {href: link}, React.createElement("img", {src: item.banner, alt: item.name, style: {width: "100%", maxWidth: "480px"}})))              
              )            
          }
        });
