  ...
  render: function() {
    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "modal-dialog", tabindex: -1, role: "dialog", style: {top: 75, left: 0, display: 'block'}}, 
          React.createElement("div", {className: "id-contents-wrapper"}, 
            React.createElement("div", {className: "contents"}, 
              React.createElement("div", {className: "base-dialog apps id-purchase-apps-container"}, 
                React.createElement("div", {className: "base-dialog-content-wrapper"}, 
                  React.createElement("div", {className: "base-dialog-image-container", style: {display: 'none'}}, " ", React.createElement("img", {'aria-hidden': "true", src: "", className: "dialog-image"}), " "), 
                  React.createElement("div", {className: "base-dialog-body-content", id: "base-dialog-body-content"}, 
                    React.createElement("div", {'data-dialog-name': "app_dialog_permission_buckets", className: "purchase-app-container bucket-grouping"}, 
                      React.createElement("div", {className: "purchase-header"}, 
                        React.createElement("div", {className: "title"}, "Angry Bird"), 
                        React.createElement("div", {className: "price"}, " ", React.createElement("span", {style: {display: 'none'}}, "Free"), " ", React.createElement("span", null, "Miễn phí"))
                      ), 
                      React.createElement("div", {className: "purchase-details"}, 
                        React.createElement("div", null, 
                          React.createElement("div", {className: "permissions-container bucket-style", jsl: "$x 2;"}, 
                            React.createElement("span", null, "Yêu cầu tải ứng dụng của bạn đang được xử lý")
                          ), 
                          React.createElement("div", {className: "permissions-learn-more contains-text-link"}, " ", React.createElement("span", null, "Yêu cầu tải ứng dụng của bạn đang được xử lý"), " "), 
                          React.createElement("div", {className: "permissions-buttons-container"}, " ", React.createElement("button", {className: "play-button apps loonie-cancel-button", id: "purchase-cancel-button"}, "Thoát")), 
                          React.createElement("div", {className: "permissions-buttons-container", style: {display: 'none'}}, " ", React.createElement("button", {className: "play-button", id: "close-dialog-button"}, "Close"), " ")
                        )
                      )
                    )
                  )
        ...
        React.createElement("div", {className: "modal-dialog-overlay", style: {display: 'block'}}), 
