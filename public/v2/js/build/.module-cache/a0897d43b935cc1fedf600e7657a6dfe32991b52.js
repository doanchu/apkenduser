    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {className: "mobile-action-bar"}, 
          React.createElement("span", {className: "action-bar-menu-button", onClick: this.showMenuBar}, " ", React.createElement("i", {class: "fa fa-align-justify fa-lg"}), " "), " ", React.createElement(Link, {to: "/", className: "play-logo", href: "/"}), " ", React.createElement("span", {className: "action-bar-search-button", onClick: this.showSearchBar}, " ", React.createElement("span", {className: "search-icon"}), " "), 
