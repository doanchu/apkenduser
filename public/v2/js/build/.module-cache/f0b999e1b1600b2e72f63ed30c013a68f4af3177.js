    ...
    return (
      React.createElement("div", {id: "footer-content"}, 
        React.createElement("div", {className: "footer"}, 
          React.createElement("div", {className: "footer-links-container"}, " ", React.createElement("span", {className: "copyright"}, React.createElement("p", null, "Trang tổng hợp game hay cho android miễn phí, nơi cung cấp những ứng dụng android mới nhất, hoàn toàn miễn phí cho điện thoại của bạn")), React.createElement("a", {className: "footer-link id-no-nav", href: "https://support.google.com/googleplay/?p=about_play", target: "_blank"}, "Về APK.VN"))
        )
      )
