    ...
    return (
      React.createElement("div", {id: "footer-content"}, 
        React.createElement("div", {className: "footer"}, 
          React.createElement("div", {className: "footer-links-container"}, React.createElement("p", null, "Trang tổng hợp game hay cho android miễn phí, nơi cung cấp những ứng dụng android mới nhất, hoàn toàn miễn phí cho điện thoại của bạn"))
        )
      )
